...
// Target audience preset to mirror edit page UI
...
export default function ReferralCreate() {
  ...
  return (
    <>
      <PageBreadCrumbs items={["Referrals", "Lists", "Create"]} />
      <Create saveButtonProps={saveButtonProps}>
        ...
        >
          ...
          <Row gutter={[16, 16]}>
            <Col xs={24} md={12}>
              <Card title="Promotional Information" style={{ marginBottom: 16 }}>
                <Form.Item
                  label="Discount"
                  name="discount"
                >
              ...
              >
                ...
                {editMode === 'form' ? (
                  <>
                    ...
                    >
                      <KeyValueList placeholder={{ key: "Feature", value: "Description" }} />
                    </Form.Item>
                    ...
                    <Form.Item
                      ...
                      getValueProps={(value) => ({ value })}
                    >
                      <KeyValueList placeholder={{ key: "Aspect", value: "Benefit" }} />
                    </Form.Item>
                    ...
                    <Form.Item
                      ...
                      getValueProps={(value) => ({ value })}
                    >
                      <KeyValueList placeholder={{ key: "Aspect", value: "Drawback" }} />
                    </Form.Item>
